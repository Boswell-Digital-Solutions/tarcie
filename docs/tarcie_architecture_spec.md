...
| Current maturity | 106 Rust unit tests and 29 frontend unit tests; CI runs both suites, a TypeScript typecheck, and a stale-document check on every pull request |
