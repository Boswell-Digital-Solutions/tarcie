...
| Current maturity | 89 Rust unit tests and 22 frontend unit tests; CI runs both suites, a TypeScript typecheck, and a stale-document check on every pull request |
