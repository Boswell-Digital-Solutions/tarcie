...
| Current maturity | 94 Rust unit tests and 27 frontend unit tests; CI runs both suites, a TypeScript typecheck, and a stale-document check on every pull request |
